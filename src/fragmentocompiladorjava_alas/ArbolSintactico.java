...
public class ArbolSintactico {
    ...
    /**
     * Se debe agregar ni más ni menos que todos los terminales en orden de una instrucción SI, MIENTRAS u ORACION definidos en sintaxis.txt.<br>
     * Este método emplea el recorrido raíz izquierda derecha para armar y agregar la rama al árbol.
     * 
     * @param terminales ArrayList<Token>
     */
